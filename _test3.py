"""1回限りの再確認用。以前成功したのと全く同じ最小構成で、今日の日付で再テストする。"""
import os
...
TARGET_URL = (
    ...
    f"/so-heads?start_date=2026-04-30&SoHeads%5Bsales_account_id%5D=3&ship_date={today_str}"
)
...
with sync_playwright() as p:
    ...
    page.screenshot(path="target_url_result3.png", full_page=True)
    ...
    print(f"today={today_str} order_link_count={order_link_count} has_download={has_download}")
