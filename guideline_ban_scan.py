...
CATEGORY_KEYWORDS = {
    ...
    "ペットフード・ペットサプリ・ペットヘアケア": [
        ...
        "pet shampoo",
        # 犬猫以外のペット（鳥・小動物など）も対象。「オウムとインコ用」のような
        # 表現だけでは対象動物か判別しにくいため、フード関連の語と併記されている
        # ものに限定するキーワードにする。2026-08-28、ユーザー指摘で発覚
        # （ZuPreem 鳥用ペレットが未検出だった）。
        "鳥用ペレット", "鳥用フード", "鳥のフード", "バードフード", "bird food",
        "小動物用フード", "小動物のフード",
    ],
...
CATEGORY_EXCLUDE_KEYWORDS = {
    "外国産米": [
        "茶", "パスタ", "プロテイン", "protein", "シロップ", "syrup",
        "クリスプ", "crisp",
    ],
